...
URL_PREFIX = "horizon:project:a10networks:a10scaling:"


class AddScalingPolicyLink(tables.LinkAction):
    name = "addscalingpolicy"
    verbose_name = _("Add Scaling Policy")
    url = "horizon:project:a10networks:a10scaling:addscalingpolicy"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateScalingPolicyLink(tables.LinkAction):
    ...
    icon = "pencil"
    # url = "horizon:project:a10networks:a10scaling:updatescalingpolicy"
    # success_url = "horizon:project:a10networks:index"

    def get_link_url(self, datum):
        base_url = reverse("horizon:project:a10networks:a10scaling:updatescalingpolicy",
...
class AddAlarmLink(tables.LinkAction):
    ...
    url = "horizon:project:a10networks:a10scaling:addalarm"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateAlarmLink(tables.LinkAction):
    ...
    classes = ("btn-update", "ajax-modal")
    icon = "pencil"
    # url = "horizon:project:a10networks:a10scaling:updatescalingalarm"
    # success_url = "horizon:project:a10networks:index"

    def get_link_url(self, datum):
        base_url = reverse("horizon:project:a10networks:a10scaling:updatealarm",
                           kwargs={'id': datum["id"]})
        return base_url
...
class DeleteAlarmLink(tables.DeleteAction):
    ...
    redirect_url = reverse_lazy("horizon:project:a10networks:a10scaling:index")
...
class AddActionLink(tables.LinkAction):
    ...
    url = "horizon:project:a10networks:a10scaling:addaction"
    classes = ("ajax-modal",)
    icon = "plus"
...
class UpdateActionLink(tables.LinkAction):
    ...
    def get_link_url(self, datum):
        base_url = reverse("horizon:project:a10networks:a10scaling:updateaction",
                           kwargs={'id': datum["id"]})
        return base_url
...
class AddReactionLink(tables.LinkAction):
    ...
    classes = ("ajax-modal",)
    icon = "plus"
    url = "horizon:project:a10networks:a10scaling:addreaction"
...
class DeleteReactionLink(tables.DeleteAction):
    ...
    icon = "minus"
    _redirect_url = "horizon:project:a10networks:a10scaling:scalingpolicydetail"
    failure_message = _('Failed to delete reaction')
...
def get_policy_detail(datum):
    return reverse_lazy("horizon:project:a10networks:a10scaling:scalingpolicydetail",
                        kwargs={"scaling_policy_id": datum["id"]})
